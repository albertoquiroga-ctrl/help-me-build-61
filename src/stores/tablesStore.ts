...
export type PaymentStatus = 'pending' | 'paid' | 'left';
...
const initialTables: WaiterTable[] = [
  {
    ...
    status: 'active', statusText: 'Confirmación pendiente', timeOpened: 45, tipTotal: 85,
  },
  {
    ...
    status: 'active', statusText: 'En orden', timeOpened: 32, tipTotal: 122,
  },
  {
    ...
    status: 'paying', statusText: 'Pagando', timeOpened: 70, tipTotal: 97,
  },
  {
    ...
    status: 'active', statusText: 'Check-in sugerido', timeOpened: 28, tipTotal: 0,
  },
  {
  ...
  },
  {
    ...
    guests: [
      { id: 'g11-1', name: 'Roberto', amountOwed: 185, amountPaid: 0, tipAmount: 0, paymentStatus: 'pending' },
