...
const initialNotifications: WaiterNotification[] = [
  ...
  { id: 'n5b', type: 'service-call', priority: 'high', tableId: '2', title: 'Llamado servicio · Mesa 2 · Comensal pide atención', subtitle: 'El comensal presionó "Hablar al mesero"', channel: 'mesas', timestamp: new Date(Date.now() - 2 * 60000).toISOString(), dismissed: false, resolved: false },
