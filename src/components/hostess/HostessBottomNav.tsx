...
const tabs = [
  { to: '/hostess/dashboard', icon: LayoutGrid, label: 'Mesas' },
  { to: '/hostess/waitlist', icon: ClipboardList, label: 'Espera' },
  { to: '/hostess/profile', icon: User, label: 'Perfil' },
];

export default function HostessBottomNav() {
